...
app.post("/posts", (req, res) => {
  ...
  posts.push({id: nextId++, created: Date.now(), author: faker.name.findName(), ...body, company: faker.name.jobType(), avatar: `https://react-router-backend-694e.onrender.com/img/${randomFile}.png`});
  res.status(204);
  res.end();
});
